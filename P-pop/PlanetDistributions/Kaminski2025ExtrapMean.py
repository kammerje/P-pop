...
class PlanetDistribution():
    ...
    def __init__(self,
        ...
        if (Scenario == 'baseline'):
            ...
            self.Rates = np.array([[0.44, 0.36, 0.40], [0.72, 0.63, 0.675], [0.11, 0.06, 0.085]])
        elif (Scenario == 'pessimistic'):
            # self.Rates = np.array([[0.49, 0.36], [0.04, 0.02]])
            self.Rates = np.array([[0.27, 0.19, 0.23], [0.49, 0.36, 0.425], [0.04, 0.02, 0.03]])
        elif (Scenario == 'optimistic'):
            # self.Rates = np.array([[1.01, 1.01], [0.22, 0.14]])
            self.Rates = np.array([[0.67, 0.61, 0.64], [1.01, 1.01, 1.01], [0.22, 0.14, 0.18]])
        elif (Scenario == 'mc'):
