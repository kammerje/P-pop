...
class PlanetDistribution():
    ...
    def __init__(self,
        ...
        # F0_0 = dblquad(func_0, 0.5/self.ytod, 500./self.ytod, 0.5, 3.4)
        
        # def func_1(R, P):
        #     return self.Gamma[1] * R**(self.alpha[1]-1.) * P**(self.beta[1]-1.)
        # F0_1 = dblquad(func_1, 0.5/self.ytod, 500./self.ytod, 3.4, 16.)
        
        # Ndraw = 100000
        # Rps = []
        # Porbs = []
        # for i in range(Ndraw):
        #     Rp, Porb = self.draw(Rp_range=[0.5, 16.], Porb_range=[0.5, 500.])
        #     Rps += [Rp]
        #     Porbs += [Porb]
