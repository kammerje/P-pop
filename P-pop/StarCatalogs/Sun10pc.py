...
class StarCatalog():
    ...
    def read(self,
        ...
        SC_out.add_row(['Sun', 10., 'G', 1., 5780., 1., 0., 0.])
        ...
        return SC_out[-1:] # select a custom subset of the full catalog here to simulate planets only around a specific sample of stars
