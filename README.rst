...
- :code:`Sun10pc`: The Sun located at a distance of 10 pc.
...
- :code:`Dressing2015Extrap`: From `Dressing et al. (2015) <https://ui.adsabs.harvard.edu/abs/2015ApJ...807...45D/abstract>`__. Extrapolated out to orbital periods of 400 days.
...
- :code:`Kaminski2025`: From `Kaminski et al. (2025) <https://ui.adsabs.harvard.edu/abs/2025A%26A...696A.101K/abstract>`__.
- :code:`Kaminski2025ExtrapLin`: From `Kaminski et al. (2025) <https://ui.adsabs.harvard.edu/abs/2025A%26A...696A.101K/abstract>`__. Extrapolated linearly in log-space out to orbital periods of 1000 days and uniformly in log-space down to masses of 0.1 Earth masses.
- :code:`Kaminski2025ExtrapMean`: From `Kaminski et al. (2025) <https://ui.adsabs.harvard.edu/abs/2025A%26A...696A.101K/abstract>`__. Extrapolated uniformly in log-space out to orbital periods of 1000 days and uniformly in log-space down to masses of 0.1 Earth masses.
...
- :code:`SAG13Extrap`: From `Kopparapu et al. (2018) <https://ui.adsabs.harvard.edu/abs/2018ApJ...856..122K/abstract>`__. Extrapolated out to orbital periods of 20000 days.
